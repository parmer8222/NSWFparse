async function fetchRule31Posts(options = {}) {
    ...
    const apiUrl = `https://api.rule31.xxx/index.php?page=dapi&s=post&q=index&tags=${options.tags.join(
        "+"
...
module.exports = { fetchRule31Posts };
